...
<body>
  ...
  <div class="container" style="color:white;">
    ...
    <div class="button-container">
      <a href="./createreceipt.php"><button class="btn btn-success">Dispatch</button></a>
      <a href="./report.php"><button class="btn btn-primary">Delivery</button></a>
